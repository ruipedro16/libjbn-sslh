...
for i in $(seq $MIN_LIMBS $MAX_LIMBS); do
    ...
    gcc cpucycles.c printbench.h bn_generic_export.s bn_generic.c -o bn.o 
    ...
    gcc cpucycles.c printbench.h bn_generic_export_ct.s bn_generic.c -o bn.o 
    ...
    # Benchmark FP SCT
    cp $ASM_DIR/$i/sct/* $BENCH_DIR
    gcc cpucycles.c printbench.h fp_generic_export.s fp_generic.c -o fp.o 
    ...
    # Benchmark FP CT
    cp $ASM_DIR/$i/ct/* $BENCH_DIR
    gcc cpucycles.c printbench.h fp_generic_export_ct.s fp_generic.c -o fp.o 
    ...
    # Benchmark ECC SCT
    cp $ASM_DIR/$i/sct/* $BENCH_DIR
    gcc cpucycles.c printbench.h ecc_generic_export.s ecc_generic.c -o ecc.o 
    ...
    # Benchmark ECC CT
    cp $ASM_DIR/$i/ct/* $BENCH_DIR
    gcc cpucycles.c printbench.h ecc_generic_export_ct.s ecc_generic.c -o ecc.o 
    echo "Running Benchmarks: ECC CT\n\n" && ./ecc.o
